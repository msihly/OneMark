try {
    ...
    app.use((req, res, next) => {
        res.header("Access-Control-Allow-Origin", `chrome-extension://${req.headers.origin === "http://localhost:3001/" ? "fbnbnkmejibjbdgpkfbkecpbiikmkagp" : "cjklnajnighcegajggjfmjecfidllinm"}`);
